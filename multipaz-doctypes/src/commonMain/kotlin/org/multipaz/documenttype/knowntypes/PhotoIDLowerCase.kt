...
/**
 * Older version of PhotoID according to ISO/IEC 23220-4 Annex C using lower-case.
 *
 * This is based on ISO/IEC JTC 1/SC 17/WG 4 N 4770 from 2025-08-20, except the doctype
 * and namespace use lowercase.
 *
 * The reason for having both [PhotoId] and [PhotoIDLowercase] is that implementations
 * in the wild use both.
 */
object PhotoIDLowercase {
    const val PHOTO_ID_DOCTYPE_LOWERCASE = "org.iso.23220.photoid.1"
    const val ISO_23220_2_NAMESPACE = "org.iso.23220.1"
    const val PHOTO_ID_NAMESPACE_LOWERCASE = "org.iso.23220.photoid.1"
    const val DTC_NAMESPACE = "org.iso.23220.dtc.1"

    /**
     * Build the PhotoID Document Type.
     */
    fun getDocumentType(): DocumentType = with(DocumentType.Builder("Photo ID (lowercase)")) {
        addMdocDocumentType(PHOTO_ID_DOCTYPE_LOWERCASE)
        ...
        addSampleRequest(
            ...
            mdocDataElements = mapOf(
                ISO_23220_2_NAMESPACE to mapOf(),
                PHOTO_ID_NAMESPACE_LOWERCASE to mapOf(),
