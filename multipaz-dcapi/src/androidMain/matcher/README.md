...
into the multipaz module where it will get picked up as part
of the identity-appsupport library. The following command-line does this

```shell
$ make clean && make -j && cp build/matcher.wasm ../../../../multipaz/src/androidMain/assets/identitycredentialmatcher.wasm
```
