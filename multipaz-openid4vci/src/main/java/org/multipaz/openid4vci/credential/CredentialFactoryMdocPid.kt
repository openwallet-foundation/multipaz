...
/**
 * [CredentialFactory] for [EUPersonalID] credentials in ISO mdoc format.
 */
class CredentialFactoryMdocPid : CredentialFactory {
    ...
    companion object {
        ...
        private val FORMAT = CredentialFormat.Mdoc(EUPersonalID.EUPID_DOCTYPE)
    }
}