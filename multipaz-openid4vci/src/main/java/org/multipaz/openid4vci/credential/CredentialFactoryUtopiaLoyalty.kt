...
/**
 * [CredentialFactory] for [Loyalty] credentials in ISO mdoc format.
 */
class CredentialFactoryUtopiaLoyalty : CredentialFactory {
    ...
    companion object Companion {
        ...
        internal val FORMAT = CredentialFormat.Mdoc(Loyalty.LOYALTY_DOCTYPE)
    }
}